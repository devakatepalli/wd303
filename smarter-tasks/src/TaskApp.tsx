  ...
  return (
    <div className="task-app">
      ...
      <div className="task-form">
        ...
        <input id="todoDueDate" type="date" value={dueDate} onChange={(e) => setDueDate(e.target.value)} />

        <button id="addTaskButton" onClick={addTask} disabled={!title.trim() || !dueDate.trim()}>Add Task</button>
      </div>
